...
South Richmond Hill, NY 11419</p>
          ...
          <div class="row justify-content-center">
            <div class="col-md-12">
              ...
              <form class="mb-5" method="post" id="contactForm" name="contactForm">
                ...
                <div class="row">
                  <div class="col-12">
                    <input type="button" value="Send Message" class="btn btn-primary rounded-0 py-2 px-4 contactSubmitBtn">
    ...
    <script src="{{asset('users/js/jquery.validate.min.js')}}"></script>
